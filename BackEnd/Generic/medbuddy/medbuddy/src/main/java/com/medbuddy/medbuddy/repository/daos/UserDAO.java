...
public class UserDAO {
    ...
    public void updateLastTimeLoggedOn(UUID userId, LocalDate date) {
        ...
        int numberOfUsersUpdated = jdbcTemplate.update(sql, Date.valueOf(date), userId.toString());
    ...
    public boolean isMedic(UUID userId) {
        ...
        if(numberOfMedicsFound == null) {
            throw new DatabaseExceptions.ErrorInExecutingStatement("Error while trying to determine whether a user is a medic");
        }

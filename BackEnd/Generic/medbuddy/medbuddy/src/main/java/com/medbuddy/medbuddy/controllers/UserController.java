...
public class UserController {
    ...
    public UserResponseBodies.UserProfile viewProfile(@PathVariable UUID userId) {
        ...
        return new UserResponseBodies.UserProfile(user,
                ImageProcessingUtil.extractImage(user.getProfileImageNumber(), user.getImageExtension(), "C:\\Users\\burca\\OneDrive\\Desktop\\UNI\\ANUL_II\\SEM_2\\Ingineria_Programarii\\Proiect_1_06\\MedBuddy\\BackEnd\\Generic\\Database\\Profiles"));
    }
    ...
    public UserResponseBodies.MedicProfile viewMedicProfile(@PathVariable UUID userId) {
        ...
        return new UserResponseBodies.MedicProfile(medic,
                ImageProcessingUtil.extractImage(medic.getProfileImageNumber(), medic.getImageExtension(), "C:\\Users\\burca\\OneDrive\\Desktop\\UNI\\ANUL_II\\SEM_2\\Ingineria_Programarii\\Proiect_1_06\\MedBuddy\\BackEnd\\Generic\\Database\\Profiles"),
                ImageProcessingUtil.extractImage(medic.getCertificateImageNumber(), medic.getCertificateExtension(), "C:\\Users\\burca\\OneDrive\\Desktop\\UNI\\ANUL_II\\SEM_2\\Ingineria_Programarii\\Proiect_1_06\\MedBuddy\\BackEnd\\Generic\\Database\\Profiles"));
    }

        ...
        >
            ...
            <div className="flex justify-between border-t  border-neutral-700 w-100 h-100 py-3">
                ...
                <div className="flex flex-col items-start justify-between text-white">
                    {/* Contact name */}
                    <h1 className="font-medium text-base mb-1">{contact}</h1>
                ...
                <div className="flex flex-col justify-between items-end h-100 text-xs">
                    {/* Time */}
                    <p className="text-[#ffffff] min-w-[55px]">{time}</p>

                    {/* Number of messages */}
                    {unreadMsgs && (
                        <div className="flex justify-center items-center bg-[#069DAE] rounded-full w-[20px] h-[20px]">
                            <p className="text-[#ffffff] mt-3">{unreadMsgs}</p>
                        </div>
                    )}
                </div>
            </div>

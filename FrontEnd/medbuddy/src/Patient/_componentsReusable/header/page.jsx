...
export default function Header({setIsMobileMenu}) {
  ...
  return (
    <>
      ...
      <Link className={styles.page} to="/home" onClick={closeMobileMenu}><img className={styles.page__header_logo} src={Logo} alt="IMAGINE"/></Link>
        <nav className={`${styles.page__header_navbar} ${isMobileMenuOpen ? styles.show : ''}`}>
          <Link className={`${styles.page__header_navbar_link} ${location.pathname === "/home" ? styles.active : ""}`} to='/home' onClick={closeMobileMenu}>Home</Link>
        ...
        <div className={`${styles.pages} ${isMobileMenuOpen ? styles.pages_show : ''}`}>
          <Link className={styles.page} to="/home" onClick={closeMobileMenu}>Home</Link>
